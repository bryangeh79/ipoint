...
describe('RequestIdMiddleware', () => {
  ...
  beforeEach(() => {
    ...
    setHeaderSpy = vi.fn();
    nextSpy = vi.fn();
    nextFn = nextSpy as NextFunction;
  ...
  it('should generate a request ID if x-request-id is not provided', () => {
    ...
    const requestId = (mockRequest as unknown as Record<string, unknown>)[
      'requestId'
    ];
  ...
  it('should reject non-string x-request-id header values', () => {
    mockRequest.headers = { 'x-request-id': ['first', 'second'] };
