...
export const canonicalPermissionCatalog = [
  ...
  permission(
    'ads.view',
    'View selected-market advertising operations.',
    'Ads & Content Operations',
    ALL,
    { marketScoped: true },
  ),
  permission(
    'ads.manage',
    'Manage selected-market advertising lifecycle.',
    'Ads & Content Operations',
    ['SUPER_ADMIN', 'OPERATIONS_ADMIN'],
    { marketScoped: true },
  ),
  permission(
    'content.view',
    'View selected-market content operations.',
    'Ads & Content Operations',
    ALL,
    { marketScoped: true },
  ),
  permission(
    'content.manage',
    'Manage selected-market content lifecycle.',
    'Ads & Content Operations',
    ['SUPER_ADMIN', 'OPERATIONS_ADMIN'],
    { marketScoped: true },
  ),
