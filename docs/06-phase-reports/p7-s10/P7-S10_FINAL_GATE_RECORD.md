...
- **K-04**: permission-name drift decision pending (`AUTH_REFRESH_REUSED` legacy alias retirement; `reports`/`settings` route-permission drift items recorded in P7-S8 Review 2).
- **K-05/K-06**: pre-existing Low observations (P7-S8/S7C lists) + 2 non-blocking eslint warnings.
