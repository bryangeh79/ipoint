...
| Merchant Group advanced behavior | Structural Account ownership and branch association only | Group UI, reporting, permissions, shared MCP and group-level settlement | Separate future authorization                            |
